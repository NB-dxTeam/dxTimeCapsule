    ...
    @objc private func didTapNextButton() {
        ...
        if #available(iOS 15.0, *) {
            ...
            if let sheet = postWritingVC.sheetPresentationController {
                ...
                // Adjust your content's layout or insets to fit the 'intermediate' size you want
            }
        } else {
            // Fallback for iOS versions below 15
            postWritingVC.modalPresentationStyle = .automatic
        }
        
        // Present the view controller if not already presenting another
