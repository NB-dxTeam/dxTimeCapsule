...
class UserProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private let usreNameLabel = UILabel()
...
//        logoutButton.backgroundColor = UIColor(hex: "#FF3A4A")
    ...
    private func setupViews() {
        ...
        usreNameLabel.font = .pretendardSemiBold(ofSize: 24)
        usreNameLabel.textAlignment = .center
...
//        logoutButton.backgroundColor = UIColor(hex: "#FF3A4A")
    ...
    private func setupConstraints() {
        ...
        usreNameLabel.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
        ...
        editUserNameButton.snp.makeConstraints { make in
            make.centerY.equalTo(usreNameLabel)
            make.leading.equalTo(usreNameLabel.snp.trailing).offset(-30)
        ...
        emailLabel.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(usreNameLabel.snp.bottom).offset(10)
            make.left.right.equalToSuperview().inset(20)
        }
    ...
    // MARK: - Loading Indicator
      private func showLoadingIndicator() {
          ...
          usreNameLabel.isHidden = true // 로딩 중에는 닉네임 레이블 숨김
      ...
      private func hideLoadingIndicator() {
          ...
          usreNameLabel.isHidden = false // 로딩 완료 후 닉네임 레이블 표시
    ...
    private func bindViewModel() {
        ...
        // 닉네임 설정
        usreNameLabel.text = userProfileViewModel.userName
...
// MARK: - Fuctions
    ...
    private func updateUserName(_ newUserName: String) {
        // Update locally
        usreNameLabel.text = newUserName
        ...
        userRef.setData(["userName": newUserName], merge: true) { error in
            if let error = error {
                ...
                self.usreNameLabel.text = self.userProfileViewModel.userName
            } else {
